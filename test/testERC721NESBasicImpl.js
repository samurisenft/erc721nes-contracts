...
describe("Token contract", function () {
  ...
  beforeEach(async function () {
    ...
    TokenFactory = await ethers.getContractFactory("ERC721NESBasicImpl");
    ...
    it("BASIC IMPL staking acrrues balance at correct rate when minting and then staking", async function () {
      ...
      await test721TokenBasic.connect(addr1).stake(0);
    ...
    it("BASIC IMPL staking prevents transfer, unstakes allows transfer", async function () {
      ...
      const trx2 = await test721TokenBasic.connect(addr1).stake(0);
      ...
      const trx3 = await test721TokenBasic.connect(addr1).unstake(0);
